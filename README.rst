...
.. code-block:: python
    ...
    long get_long(col_id_or_col_name)
    float get_float(col_id_or_col_name)
    double get_double(col_id_or_col_name)
    date_vals get_date(col_id_or_col_name)
    datetime_vals get_datetime(col_id_or_col_name)
    string get_varchar(col_id_or_col_name)
    string get_nvarchar(col_id_or_col_name)
